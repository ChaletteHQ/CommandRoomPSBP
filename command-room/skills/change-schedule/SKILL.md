...
Background maintenance (runs quietly, no chat output):
  Maintenance         — 6:30 AM, 6:45 AM, 12:30 PM, 12:45 PM, 4:30 PM,
                        ...
                        booked meeting check, memory coverage check,
                        monthly report
                        — each runs when due)
