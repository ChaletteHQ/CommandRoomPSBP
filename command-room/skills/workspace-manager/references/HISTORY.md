...
| Routing-miss | 2026-05-20 | Asked 4 open-ended clarifying questions for "my conversation with Arya" when Aria was a known person — the resolver would have matched. Origin of the strict Step-5 single-question shape (4-clarifying-question shape is the regression). | "Step 5 — Ambiguity handling (strict shape)" / step-3 candidate rule | v3.13.1 |
